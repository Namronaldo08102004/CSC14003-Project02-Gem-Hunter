...
def display(board: list[list[str]], msg: str = None):
    ...
    top_border = bytes([218] + ([196]*3 + [194]) * (c - 1) + [196]*3 + [191]).decode("cp437")
    middle_border = bytes([195] + ([196]*3 + [197]) * (c - 1) + [196]*3 + [180]).decode("cp437")
    bottom_border = bytes([192] + ([196]*3 + [193]) * (c - 1) + [196]*3 + [217]).decode("cp437")
